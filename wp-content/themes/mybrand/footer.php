...
jQuery(".woodmart-ajax-search").attr('id', 'cat-form');
jQuery(" #cat-form").css("display","none");

//jQuery("input[name=product_start_date]").val();
//alert(jQuery(".form-row-first #abc").text(jQuery('input[name=product_start_date]').val()));
