<br/><strong style="display:block; clear:both; margin-top: 0px;"><?php _e('Ships to','woocommerce-multiple-customer-addresses'); ?></strong>
<?php 			
...
endforeach; 
	...
	{
		echo '<br/><strong style="display:block; clear:both; margin-top: 0px;">'.__('Notes','woocommerce-multiple-customer-addresses').'</strong>';
		echo $address['notes'];
	}
?>
