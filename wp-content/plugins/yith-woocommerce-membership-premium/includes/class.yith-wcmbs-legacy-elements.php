			...
			<div class="yith-wcmbs-membership-legacy-menu-wrap">
				<div class="yith-wcmbs-membership-legacy-menu__notice">
					<div class="yith-wcmbs-membership-legacy-menu__notice__text">
						...
						echo sprintf( esc_html__( 'Since version %1$s of %2$s we moved all membership settings to a new panel that you can find in %3$s, so you can access to all plugin settings from there.', 'yith-woocommerce-membership' ),
									  '<strong>1.4.0</strong>',
		...
		public function render_legacy_set_access_meta_box() {
			...
			<div class="yith-wcmbs-legacy-set-access">
				<div class="yith-wcmbs-legacy-set-access__notice">
					...
					echo sprintf( esc_html__( 'Since version %1$s of %2$s we moved the options of the "Set access" box to the new "%3$s" box.', 'yith-woocommerce-membership' ),
								  '<strong>1.4.0</strong>',
								  '<strong>YITH WooCommerce Membership</strong>',
					...
					$( '.yith-wcmbs-legacy-set-access__notice__cta' ).on( 'click', function ( e ) {
						...
						$.ajax( {
									...
									data    : {
										...
										security: '<?php echo wp_create_nonce( 'remove-legacy-set-access-meta-box' ); ?>'
									},
									complete: function () {
