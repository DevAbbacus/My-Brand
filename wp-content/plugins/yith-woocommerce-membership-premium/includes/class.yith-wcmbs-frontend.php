...
if ( ! class_exists( 'YITH_WCMBS_Frontend' ) ) {
	...
	class YITH_WCMBS_Frontend {
		...
		protected function __construct() {
			...
			add_filter( 'woocommerce_product_is_on_sale', array( $this, 'set_on_sale_with_membership_discount' ), 10, 2 );
			add_filter( 'woocommerce_product_get_price', array( $this, 'discount_product_price' ), 10, 2 );
			add_filter( 'woocommerce_product_variation_get_price', array( $this, 'discount_product_price' ), 10, 2 );
			add_filter( 'woocommerce_variation_prices', array( $this, 'discount_variation_prices' ), 10, 2 );
		...
		public function redirect_if_not_have_access() {
			...
			if ( $user_has_no_access ) {
				...
				$custom_redirect_link = get_post_meta( $post_id , '_yith_wcmbs_custom_redirect', true );
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_style( 'yith-wcmbs-frontent-styles', YITH_WCMBS_ASSETS_URL . '/css/frontend.css' );
			...
			$frontend_js_deps = apply_filters( 'yith_wcmbs_frontend_js_deps', array( 'jquery', 'jquery-ui-accordion', 'jquery-ui-tabs', 'jquery-ui-tooltip', 'jquery-blockui' ) );
			...
			wp_localize_script( 'yith_wcmbs_frontend_js', 'yith_wcmbs_frontend', array(
