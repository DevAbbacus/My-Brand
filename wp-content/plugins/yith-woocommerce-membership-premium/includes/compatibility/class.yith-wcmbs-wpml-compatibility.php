...
class YITH_WCMBS_Wpml_Compatibility {
    ...
    public function show_title_translations_metabox( $post ) {
        ...
        foreach ( $languages as $language_code => $language ) {
            ...
            ?>
            <p>
                <label for="yith_wcmbs_wpml_title_translations_<?php echo $language_code; ?>"><?php echo sprintf( __( 'Title (%s)', 'yith-woocommerce-membership' ), $language_name ) ?></label>
                <input type="text" name="<?php echo $name; ?>"
                       id="yith_wcmbs_wpml_title_translations_<?php echo $language_code; ?>"
