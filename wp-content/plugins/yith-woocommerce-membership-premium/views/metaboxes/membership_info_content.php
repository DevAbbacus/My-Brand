	...
	<div class="membership_data_column_container">
		<div class="membership_data_column">
			...
			<p class="field_info"><label><strong><?php _e( 'Expiration Date', 'yith-woocommerce-membership' ) ?>:</strong></label>
				<?php echo apply_filters( 'yith_wcmbs_admin_membership_info_expiration_date', $membership->get_formatted_date( 'end_date' ), $membership ); ?>
			</p>
		...
		<div class="membership_data_column">
			...
			<?php if ( $membership->has_discount() ): ?>
				<h4><?php _e( 'Discounts', 'yith-woocommerce-membership' ) ?></h4>
				<p class="field_info"><label><strong><?php _e( 'Shop Discount', 'yith-woocommerce-membership' ) ?>:</strong></label>
					<?php echo $membership->get_discount_html(); ?>
				</p>
			<?php endif ?>
