...
<div id="yith-wcmbs-download-reports-downloads-by-product">
    <div class="yith-wcmbs-reports-filters">
        ...
        <input type="button" class="yith-wcmbs-reports-filter-button button button-primary" value="<?php _e( 'Filter', 'yith-woocommerce-membership' ) ?>">
        <input type="button" class="yith-wcmbs-reports-filter-reset button button-secondary" value="<?php _e( 'Reset Filters', 'yith-woocommerce-membership' ) ?>">
    </div>
