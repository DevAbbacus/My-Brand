...
<div class="postbox yith-wcmbs-reports-metabox opened">
    ...
    <div class="yith-wcmbs-reports-content">
        ...
        <div class="yith-wcmbs-reports-subtitle"><span class='yith-wcmbs-membership-status-text active yith-wcmbs-membership-status-with-margin'><?php _e('active + resumed', 'yith-woocommerce-membership')?></span></div>
    </div>
