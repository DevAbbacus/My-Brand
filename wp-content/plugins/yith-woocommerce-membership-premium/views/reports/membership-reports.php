            ...
            <div class="yith-wcmbs-reports-content">
                ...
                foreach ( $active_statuses as $current_active_status ) {
                    ...
                    if ( $current_status_count > 0 )
                        echo "<span class='yith-wcmbs-membership-status-text $current_active_status yith-wcmbs-membership-status-with-margin'>$current_status_label: $current_status_count</span>";
                }
                ?>
            </div>
        <?php endif; ?>
    ...
    <div class="postbox yith-wcmbs-reports-metabox">
        ...
        <div class="yith-wcmbs-reports-content">
            <table class="yith-wcmbs-reports-table-membership">
                ...
                <tr>
                    <th><?php _e( '7 days', 'yith-woocommerce-membership' ) ?></th>
        ...
        <?php if ( $membership_ever_count > 0 ): ?>
            <div class="yith-wcmbs-reports-content">
                ...
                foreach ( $membership_statuses as $current_status => $current_status_label ) {
                    ...
                    if ( $current_status_count > 0 )
                        echo "<span class='yith-wcmbs-membership-status-text $current_status yith-wcmbs-membership-status-with-margin'>$current_status_label: $current_status_count</span>";
                }
                ?>
            </div>
        <?php endif; ?>
