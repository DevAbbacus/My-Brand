...
<div class="yith-wcmbs-download-reports-downloads-details-by-user-totals" data-user_id="<?php echo $user_id; ?>">
    ...
    if ( $user_downloads ) {
        ...
        $downloads = "<table><tr><th>" . __( 'Total Downloads', 'yith-woocommerce-membership' ) . "</th><td>$user_downloads->downloads</td><th>" . __( 'Unique Downloads', 'yith-woocommerce-membership' ) . "</th><td>$user_downloads->distinct_downloads</td></tr></table>";
...
>
    <div class="yith-wcmbs-reports-filters">
        ...
        <input type="button" class="yith-wcmbs-ajax-table-apply-button button button-primary" value="<?php _ex( 'Apply', 'Download reports: apply button', 'yith-woocommerce-membership' ) ?>">
    </div>
