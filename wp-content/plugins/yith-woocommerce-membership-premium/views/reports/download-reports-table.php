		...
		<?php foreach ( $results as $result ) : ?>
			<tr>
				<td class="title-col"><?php
					...
					echo "<a href='$view_link' target='_blank'>" . esc_html__( 'View', 'yith-woocommerce-membership' ) . "</a>";
					echo "| ";
					echo "<a href='$edit_link' target='_blank'>" . esc_html__( 'Edit', 'yith-woocommerce-membership' ) . "</a>";
					echo "</div>";
					?></td>
