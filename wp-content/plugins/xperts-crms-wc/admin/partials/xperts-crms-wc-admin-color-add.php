...
<div class="wrap">
    ...
    <form method="post" action="<?php echo admin_url('admin.php?page=xperts-crms-color-map&action=add');?>">
        <?php wp_nonce_field('xperts_crms_color_map_save','xperts_crms_color_map_save'); ?>
        <?php
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input name="crms_color" type="text" id="crms_color" value="<?php echo $this->get_form_field('crms_color');?>" class="regular-text">
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <?php
                        echo wc_product_dropdown_categories([
                                ...
                                'value_field'=>'id',
                                'show_option_none'=>'',
                                'selected' => (isset($_POST['color_mappings'])?$_POST['color_mappings']:''),
                        ]);
                    ?>
                </td>
            </tr>
