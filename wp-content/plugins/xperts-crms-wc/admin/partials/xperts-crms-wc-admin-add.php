...
<div class="wrap">
    <h1 class="wp-heading-inline">
        <?php echo get_admin_page_title();?> :: Add New Mapping
    </h1>
    <hr class="wp-header-end">

    <form method="post" action="<?php echo admin_url('admin.php?page=xperts-crms-cmap&action=add');?>">
        <?php wp_nonce_field('xperts_crms_cmap_save','xperts_crms_cmap_save'); ?>
        <?php
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input name="crms_category" type="text" id="crms_category" value="<?php echo $this->get_form_field('crms_category');?>" class="regular-text">
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <?php
                        echo wc_product_dropdown_categories([
                                ...
                                'value_field'=>'id',
                                'show_option_none'=>'',
                                'selected' => (isset($_POST['category_mappings'])?$_POST['category_mappings']:''),
                        ]);
                    ?>
                </td>
            </tr>
