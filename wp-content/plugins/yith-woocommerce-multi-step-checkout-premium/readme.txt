...
= 2.0.9 - Released on 09 February 2021 =

* New: support for WooCommerce 5.0
* Update: YITH plugin framework
* Dev: hook yith_wcms_main_script_deps to filter the main script dependencies

= 2.0.8 - Released on 11 January 2021 =

* New: Support for WooCommerce 4.9
* Fix: Minor issues in shipping fields validation
* Fix: Wrong redirection url on login form
* Fix: Disable YITH Gift Card form field on checkout not working
* Fix: "Order notes" and "Ship to a different address?" fields can't be cached

= 2.0.7 - Released on 03 December 2020 =

* New: Support for WooCommerce 4.8
* New: Support for WordPress 5.6
* New: Support for Twenty Twenty-One theme
* Fix: Minor style issues on latest Storefront
* Fix: Unable to go to the next step if billing and shipping step where merged and create account aren't checked
* Fix: Issue with 'create a new account' fields validation
* Fix: Validation doesn't works with required text-area field added by YITH WooCommerce Checkout Manager
* Fix: Unable to skip login if 'create account' was checked by default

= 2.0.6 - Released on 09 November 2020 =

* New: Possibility to update plugin via WP-CLI
* New: Support for WooCommerce 4.7
* Update: Plugin framework
* Tweak: Removed deprecated jQuery.on('ready', handler) method
* Tweak: Navigation script refactoring
* Tweak: Support for required fields added by YITH WooCommerce Checkout Manager
* Fix: Unable to go to the next step if billing and shipping step were merged
* Fix: Missing padding-left for Style2 on mobile view

= 2.0.5 - Released on 13 October 2020 =

* New: Support for WooCommerce 4.6
* New: Support for Brazilian Market on WooCommerce
* New: Support for Medizin theme
* Fix: Undefined index "hover" in style text template
* Dev: yith_wcms_step_changed js trigger after a step has changed

= 2.0.4 - Released on 24 September 2020 =

* Fix: Unable to change step if the admin hides the prev/next buttons
