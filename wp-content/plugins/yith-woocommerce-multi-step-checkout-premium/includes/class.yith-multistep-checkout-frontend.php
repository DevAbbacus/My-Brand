...
if ( ! class_exists( 'YITH_Multistep_Checkout_Frontend' ) ) {
    ...
    class YITH_Multistep_Checkout_Frontend {
        ...
        public function __construct(){
            ...
            if( function_exists( 'YITH_YWGC' ) &&  get_option( 'ywgc_gift_card_form_on_checkout', 'yes' ) == 'yes' ){
        ...
        public function enqueue_scripts(){
	        ...
	        $wcms_deps = apply_filters( 'yith_wcms_main_script_deps', array( 'wc-checkout', 'wc-country-select', 'wc-password-strength-meter' ) );
