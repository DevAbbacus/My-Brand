jQuery(document).ready(function ($) {
    ...
    var validate_field = function( field ){
        ...
        for( var i=0; i<n_conditions; i++ ){
            ...
            var condition_is_valid = validate_condition( condition );
            var condition_action = condition.action;
            var condition_required = condition.required;
            var input_name = condition.input_name;
    ...
    $('form.checkout').find('input, select').trigger('change');
