...
=== Version 1.6.0 === Released on 08 April 2021

* New: support for WooCommerce 5.2
* New: German translation
* New: include the additional fields to the list of conditional fields
* Update: YITH plugin framework
* Update: language files
* Fix: heading fields visibility in order address details

=== Version 1.5.0 === Released on 02 March 2021

* New: support for WordPress 5.7
* New: support for WooCommerce 5.1
* Update: YITH plugin framework
* Update: language files
* Fix: issues with conditions for heading fields
* Fix: issues with conditions based on products in cart

=== Version 1.4.6 === Released on 02 February 2021

* New: support for WooCommerce 5.0
* Update: YITH plugin framework
* Update: language files

=== Version 1.4.5 === Released on 11 January 2021

* New: Support for WooCommerce 4.9
* Update: Plugin framework
* Update: Language files

=== Version 1.4.4 === Released on 04 December 2020

* New: Support for WooCommerce 4.8
* New: Option to customize date format
* Update: Plugin framework
* Update: Language files

=== Version 1.4.3 === Released on 03 November 2020
...
=== Version 1.4.2 === Released on 12 October 2020

* New: Support for WooCommerce 4.6
* Update: Plugin framework
* Update: Language files
* Dev: New filter 'ywccp_datepicker_allowed_days'

=== Version 1.4.1 === Released on 17 September 2020

* New: Support for WooCommerce 4.5
* Update: Plugin framework
* Update: Language files

=== Version 1.4.0 === Released on 11 August 2020

* New: Support for WooCommerce 4.4
* New: Support for WordPress 5.5
* Update: Plugin framework
* Update: Language files
* Fix: Condition based on product category in cart didn't work
* Dev: New filter 'ywccp_ship_different_address_old_behaviour'
